          ...
          <>
            <div className="mt-7 grid sm:grid-cols-2 gap-4">
              <div className="rounded-xl border border-border bg-card/40 p-5">
                <p className="font-mono text-[10px] uppercase tracking-widest text-body mb-2">Owns the client</p>
                <p className="text-sm text-foreground">{enriched.ownsClient}</p>
              </div>
              <div className="rounded-xl border border-border bg-card/40 p-5">
                <p className="font-mono text-[10px] uppercase tracking-widest text-body mb-2">CiteWorks Studio role</p>
            ...
            <div className="mt-5 rounded-xl border border-border bg-card/40 p-5">
              <p className="font-mono text-[10px] uppercase tracking-widest text-body mb-3">Best when</p>
