      ...
      <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {fits.map((c) => (
          <article key={c.title} className="group card-premium p-8 hover:border-primary/40 transition-colors">
            ...
            <Link to="/request-audit" className="mt-5 inline-flex items-center gap-1 font-mono text-[13px] font-semibold tracking-[0.14em] text-primary hover:gap-2 transition-all">
